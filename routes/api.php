...
Route::prefix('authentication')->name('authentication.')->group(function (){
    ...
    Route::post('questions/{question}/type/users/{user}', [\App\Http\Controllers\Api\Admin\Poll\QuestionController::class, 'userType']);
    Route::post('questions/{question}/type/groups/{group}', [\App\Http\Controllers\Api\Admin\Poll\QuestionController::class, 'groupType']);
